report 50014 "CBR Daily Invoicing Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DailyInvoicingReport_CBR.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'CBR Daily Invoicing Report';
    ...
    dataset
    {
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                RequestFilterFields = "Bill-to Customer No.", "Salesperson Code", "Payment Terms Code";
