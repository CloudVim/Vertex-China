report 50008 "CBR Stub/Stub/Check"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CBR_StubStubCheck.rdl';
    Caption = 'CBR Check (Stub/Stub/Check)';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(BankAddr_1; BankAddr[1]) { }
            column(BankAddr_2; BankAddr[2]) { }
            column(BankAddr_3; BankAddr[3]) { }
            ...
            trigger OnAfterGetRecord()
            begin
                If BankAccount_G.get(BankAcc2."No.") then begin
                    BankAddr[1] := BankAccount_G.Address;
                    BankAddr[2] := BankAccount_G.City + ', ' + BankAccount_G.County + ' ' + BankAccount_G."Post Code";
                    BankAddr[3] := BankAccount_G."Phone No.";
                end;
    ...
    var
        ...
        BankAccount_G: Record "Bank Account";
