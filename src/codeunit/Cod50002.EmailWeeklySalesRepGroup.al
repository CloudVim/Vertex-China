// codeunit 50002 "Email_Weekly Sales Rep Group"
// {
//     trigger OnRun()
//     var
...
//                 Body := 'Hi,';
//                 Body += 'Please find attached for Weekly Sales By Rep Group Report';
...
//                     end;
//                 end;
//                 EmailMessage.create(SendToList, 'Weekly Sales By Rep Group Report ', Body, TRUE, SendToCcList, SendToBccList);
//                 tmpBlob.CreateOutStream(OutStr);
//                 Report.SaveAs(Report:: , '', ReportFormat::Excel, OutStr);
//                 tmpBlob.CreateInStream(InStr);
//                 EmailMessage.AddAttachment('Weekly Sales By Rep Group Report.Xlsx', 'Xlsx', InStr);
