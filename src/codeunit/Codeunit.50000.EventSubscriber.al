codeunit 50000 EventSubcriber_VertexChina
{
    ...
    local procedure UpdateContactData(VAR SalesHeader: Record "Sales Header"; SellToCustomer: Record Customer)
    begin
    ...
    local procedure UpdateContactData1(VAR SalesHeader: Record "Sales Header"; ShipToAddress: Record "Ship-to Address")
    begin
